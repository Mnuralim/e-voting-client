...
export default function Home() {
  return (
    <main className="grid lg:grid-cols-2 relative gap-x-16 w-full max-w-7xl mx-auto text-white md:h-[calc(100vh-90px)] lg:mt-[90px] h-[calc(100vh-80px)] mt-[80px] px-4">
      <div className="flex flex-col gap-y-3 md:gap-y-8 justify-center order-2 lg:order-1">
        <h1 className="font-bold text-2xl md:text-3xl xl:text-5xl xl:leading-16">
